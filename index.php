<?php
session_start();
include_once 'app/classes/main-page/main-page.php';
include_once 'app/classes/pagination/pagination-controller.class.php';
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5><a href="<?='single-page.php?id=' . $post->id?>"><?=$post->title;?></a></h5>
                </div>
            </div>
            <?php endif; ?>
            <?php endforeach;?>
