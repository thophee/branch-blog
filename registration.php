<?php
    include 'app/classes/users/user.php';
    $view = new UserView();
?>
<html lang="en">
<head>
...
<form class="row justify-content-center" method="post">
    ...
    <div class="w-100"></div>
    <div class="text-danger mb-2 col-12 col-md-4">
        <?php
        foreach (['empty_fields', 'short_username', 'user_exists', 'restricted_chars', 'password_not_match'] as $error) {
    ...
    <div class="w-100"></div>
    <div class="mb-3 col-12 col-md-4">
         <input type="submit" name="sign_up" class="btn btn-primary" value="Register">
