<?php
include 'app/classes/main-page/single-post.php';
include 'app/classes/comments/comments.php';
include_once __DIR__ . '/app/classes/topics/admin-topic-controller.class.php';
$view = new SinglePageView();
?>
...
<div class="container">
    <div class="content row">
        <div class="main-content col-md-9 col-12">
            <h2>
                <a href="<?='single-page.php?id=' . $view->getPost()->id?>"><?=$view->getPost()->title?></a>
            </h2>
