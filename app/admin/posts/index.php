        ...
        <div class="posts col-9">
            ...
            <div class="row title-table">
                ...
                <div class="row post">
                    ...
                    <div class="edit col-1"><a href="edit.php?edit_id=<?=$post->id;?>">edit</a></div>
                    <div class="delete col-1"><a href="edit.php?delete_id=<?=$post->id;?>">delete</a></div>
                    <?php if ($post->published): ?>
                    <div class="status col-1"><a href="edit.php?published=0&pub_id=<?=$post->id;?>">hide</a></div>
                    <?php else: ?>
                    <div class="status col-1"><a href="edit.php?published=1&pub_id=<?=$post->id;?>">show</a></div>
                    <?php endif;?>
                </div>
                <?php endforeach;?>
