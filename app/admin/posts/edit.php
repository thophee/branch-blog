    ...
    <div class="row">
        ...
        <div class="posts col-9">
            <div class="button  row">
                <a href="/create" class="col-2 btn btn-primary">Create</a>
            ...
            <div class="row add-post">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-check">
                        <?php if(empty($view->post->trending) || $view->post->trending == 0): ?>
                            <input name="trending" class="form-check-input" type="checkbox" id="flexCheckChecked">
                            <label class="form-check-label" for="flexCheckChecked">
                                Trending
                            </label>
                        <?php else: ?>
                            <input name="trending" class="form-check-input" type="checkbox" id="flexCheckChecked" checked>
                            <label class="form-check-label" for="flexCheckChecked">
                                Trending
                            </label>
                        <?php endif; ?>
                    ...
                    <div class="form-check">
                        <?php if(empty($view->post->published) || $view->post->published == 0): ?>
                    ...
                    <div class="col col-6 ">
                        <button name="edit_post" type="submit" class="btn btn-primary">Save post</button>
                    </div>
                </form>
            </div>
        </div>
