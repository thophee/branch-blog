        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col mb-4">
                        <input value="<?=$view->title;?>" name="title" type="text" class="form-control" placeholder="Title" aria-label="Article name">
                    </div>
                    <div class="col mb-4">
                        <label for="editor" class="form-label">Article text</label>
                        <textarea name="content" id="editor" class="form-control" rows="6"><?=$view->content;?></textarea>
                    </div>
                    ...
                    <div class="form-check">
                        <input name="trending" class="form-check-input" type="checkbox" value="1" id="flexCheckChecked">
