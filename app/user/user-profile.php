    ...
    <div class="row">
        ...
        <div class="posts ">
            <div class="button  row">
                <a href="/create-post-user" class="col-2 btn btn-primary">Create post</a>
            ...
            <?php foreach ($view->getPosts() as $key => $post): ?>
                <div class="row post">
                    ...
                    <div class="edit col-2"><a href="edit-post-user/<?=$post->id;?>">edit</a></div>
                    <div class="delete col-2"><a href="delete-post-user/<?=$post->id;?>/delete">delete</a></div>
                </div>
            <?php endforeach;?>
            <?php endif;?>
        </div>
